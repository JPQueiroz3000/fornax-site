...
async function calculateShipping() {
    ...
    const cepDestino = document.getElementById("cep-input").value.replace(/\D/g, "");    const cepOrigem = "02469120"; // CEP fixo da sede
...
document.getElementById("calculate-shipping-btn").addEventListener("click", async function(e) {
    ...
    if (errorSection) errorSection.style.display = "none"; // Verifica se o elemento existe
